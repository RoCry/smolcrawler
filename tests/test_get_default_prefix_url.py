...
def test_get_default_url_prefix():
    ...
    assert (
        get_default_url_prefix("https://docs.scylladb.com/manual/stable/")
    ...
    assert (
        get_default_url_prefix("https://deepwiki.com/groue/GRDB.swift")
        == "https://deepwiki.com/groue/GRDB.swift"
    )
    assert (
        get_default_url_prefix("https://deepwiki.com/groue/GRDB.swift/")
        == "https://deepwiki.com/groue/GRDB.swift"
